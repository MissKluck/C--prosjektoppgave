...
public class CharactersController : ControllerBase
{
    ...
    private static List<Characters> characters = new List<Characters>{
        new Characters {Id = 1, Name = "Chihiro", Age = 10, Film = "Spirited Away", About = "A young girl who just had to move from all her friends, Chihiro is timid and scared when she and her parents end up visiting the spirit world on accident. When her parents are turned into pigs, Chihiro has to find her own courage in order to save them, and ends up reconnecting with an old friend along the way.", ImageUrl = "http://localhost:5230/images/chihiro.jpg"},
        new Characters {Id = 2, Name = "San", Age = 17, Film = "Princess Mononoke", About = "San is a young woman who was raised by the wolves and fights alongside them to protect the forest. Initially rejecting her own humanity, she comes to appreciate it while working alongside Ashitaka to save the forest spirit.", ImageUrl = "http://localhost:5230/images/san.jpg"},
        new Characters {Id = 3, Name = "Sophie", Age = 18, Film = "Howl's Moving Castle", About = "A young woman cursed to turn into an old woman. She goes in search of Howl's moving castle in order to break her spell, and finds her self-confidence along the way.", ImageUrl = "http://localhost:5230/images/sophie.jpg"},
        new Characters {Id = 4, Name = "Sheeta", Age = 13, Film = "Laputa: Castle In The Sky", About = "Sheeta is unknowingly the last heir to the throne of a kingdom floating in the sky named Laputa. Escaping from the government, she works together with both Pazu and a band of air pirates in order to save both herself and what is left of her kingdom from falling into the wrong hands.", ImageUrl = "http://localhost:5230/Sheeta_3.jpg"},
